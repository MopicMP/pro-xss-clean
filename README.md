...
> Pro sanitize html input to prevent xss

[![PyPI version](https://badge.fury.io/py/pro-xss-clean.svg)](https://pypi.org/project/pro-xss-clean/)
...
from pro_xss_clean import batch
